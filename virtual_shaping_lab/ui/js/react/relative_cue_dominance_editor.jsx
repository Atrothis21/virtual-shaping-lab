...
function RelativeCueDominanceApp() {
  ...
  return (
    <>
      <h1>Relative Cue Dominance Preset</h1>
      <p>Single compound-acquisition phase with unequal cue salience.</p>
...
root.render(<RelativeCueDominanceApp />);
