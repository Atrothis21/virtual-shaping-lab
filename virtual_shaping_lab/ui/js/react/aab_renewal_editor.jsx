...
function AABRenewalApp() {
  ...
  return (
    <>
      <h1>AAB Renewal Preset</h1>
      <p>Protocol: Acquisition in A -&gt; Extinction in A -&gt; Probe in B.</p>
