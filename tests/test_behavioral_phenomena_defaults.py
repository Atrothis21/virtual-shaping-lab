...
from preset_payloads import (
    ...
    acquisition_payload,
    blocking_payload,
    conditioned_inhibition_payload,
...
def test_conditioned_inhibition_summation_probe_below_excitatory_asymptote_default_payload():
    records = _run_records(conditioned_inhibition_payload())
...
def test_conditioned_inhibition_retardation_starts_below_initial_acquisition_default_payload():
    records = _run_records(conditioned_inhibition_payload())
    acquisition = [r for r in records if r.get("subphase_name") == "acquisition"]
